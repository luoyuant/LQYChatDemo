...
@interface LQYGrowingTextView () <UITextViewDelegate>

@property (nonatomic,strong) LQYTextView *textView;
...
@implementation LQYGrowingTextView
...
@implementation LQYGrowingTextView (TextView)
